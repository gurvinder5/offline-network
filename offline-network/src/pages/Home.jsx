      ...
      <section className="hero-panel">
        <div>
          ...
          <div className="action-row" style={{ marginTop: 16 }}>
            ...
            <Link to="/connect" className="secondary-button" style={{ border: "1px solid var(--amber)", color: "var(--amber)" }}>
              📶 Hardware Sync: Bluetooth & Local WiFi
            </Link>
          </div>
        </div>
      ...
      <section className="panel-grid">
        <article className="info-panel">
          ...
          <ol className="steps">
            ...
            <li>Open <strong>Hardware Sync</strong> to access live <strong>Bluetooth Mesh</strong> node discovery or <strong>Local Wi-Fi</strong> syncing.</li>
            <li>Alternatively, use <strong>Manual Bundle</strong> or <strong>QR Drop</strong> for completely air-gapped data relay.</li>
            <li>Third device receives via relay → multi-hop propagation complete over varied local hardware transports.</li>
          </ol>
        </article>
